...
export const DashboardModule: React.FC<DashboardModuleProps> = ({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('fluxglow_flux_streak_updated', handleStreakUpdate);
    return () => window.removeEventListener('fluxglow_flux_streak_updated', handleStreakUpdate);
  }, []);
    ...
    <div className="w-full bg-flux-brand-bath min-h-screen pb-24 pt-4 px-4 sm:px-6 lg:px-8 text-stone-800 overflow-x-hidden">
      <div className="max-w-[1280px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
          ...
          <div 
            className="flux-card-terracotta p-4 sm:p-5 group flex flex-col justify-between"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-[11px] font-bold uppercase tracking-wider text-[#B54F2C] truncate">
                Racha Flux
            ...
            <div>
              ...
              <div className="mt-2.5 pt-2 border-t border-[#F7D3C3]/50 flex items-center justify-between text-[11px] font-semibold text-[#B54F2C]">
                <span>Puntos Totales de Flux</span>
                <Sparkles className="w-3.5 h-3.5 text-[#E87A52] group-hover:scale-110 transition-transform" />
              </div>
            </div>
          </div>
