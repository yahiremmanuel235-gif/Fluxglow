...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-bold rounded-full transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer select-none active:scale-[0.98]';

  const sizeClasses = {
    xs: 'text-[11px] px-3.5 py-1.5 gap-1.5 rounded-full',
    sm: 'text-xs px-4 py-2 gap-1.5 rounded-full',
    md: 'text-sm px-6 py-2.5 gap-2 rounded-full',
    lg: 'text-base px-8 py-3.5 gap-2.5 rounded-full',
  };
